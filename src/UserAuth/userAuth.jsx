...
const UserAuth = () => {
    ...
    const onSignIn = async () => {
        ...
        try {
            ...
            if (response && response.status === 200) {
                const token = response.data.authToken; // Make sure you're using the correct property name
                    ...
                    {isSelected ? (
                        <MDBCol col="4" md="6">
                            <div className="vertical-center border-style">
                                ...
                                >
                                    <MDBTabsItem>
                                        <MDBTabsLink
                                            ...
                                            className="header-title bg-color-cus"
                                        >
                                            Login
                                        </MDBTabsLink>
                                    </MDBTabsItem>
                                ...
                                <MDBTabsContent>
                                    <MDBTabsPane
                                        open={justifyActive === "tab1"}
                                    >
                                        <p className="margin-bottom2">
                                            Username
                                        </p>
                                        <MDBInput
                                            wrapperClass="mb-4"
                        ...
                        <MDBCol col="4" md="6">
                            <div className="vertical-center border-style">
                                ...
                                <br />
                                <p
                                    className="margin-bottom2 text-center"
                                    style={{ fontSize: "20px" }}
                                >
                                    Join in as a Client or Freelancer?
                                </p>
                                <br />
                                <MDBTabs
                                    pills
                                ...
                                >
                                    <MDBTabsItem>
                                        <MDBTabsLink
                                            onClick={() =>
                                                handlelogClick("client")
                                            }
                                            active={logged === "client"}
                                            className="header-title bg-color-cus"
                                        >
                                            Client
                                        </MDBTabsLink>
                                    ...
                                    <MDBTabsItem>
                                        <MDBTabsLink
                                            onClick={() =>
                                                handlelogClick("freelancer")
                                            }
                                            active={logged === "freelancer"}
                                            className="header-title bg-color-cus"
                                        >
                                            Freelancer
                                        </MDBTabsLink>
